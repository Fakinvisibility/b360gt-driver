...
正方形的水冷屏幕好像天然适合显示专辑封面，实践后发现的确如此。
这种小小的乐趣非常让人心情愉快，所以这块屏幕在Linux系统下也应当亮起来。
目前的功能已经足以满足最初的开发目的了。性能参数叠加层的存在纯粹是为了满足某
种机箱里的屏幕好像必须要用来显示性能占用的强迫性思维。所以参数叠加层仅支持四个
固定位置，能避开封面中的重要内容就够了。为了保持简单，系统提供什么参数就显示
什么，不额外接入其他采集工具。它的主要工作是展示专辑封面，不是冒充性能监控面板。

**在这里强烈感谢并推荐一个专辑封面下载站：[CoverBox](https://coverbox.henry-hu.com/index.html)**

# Valkyrie B360GT 水冷屏驱动

适用于瓦尔基里 B360GT USB 水冷屏幕的非官方开源用户态驱动。项目可在
...
当前发布候选版本为 `1.0.0rc3`。实机已验证静态图、GIF、MP4、Web
控制台和后台服务；项目尚未宣称为稳定版。
